	...
	Game.Init=function()
	{
		...
		*/
		...
		Game.mouseCps=function()
		{
			...
			if (Game.Has('Septillion fingers')) add*=	30;
			if (Game.Has('Octillion fingers')) add*=	30;
			if (Game.Has('Nonillion fingers')) add*=	40;
		...
		new Game.Upgrade('Billion fingers','Multiplies the gain from Thousand fingers by <b>5</b>.<q>clickityclickityclickity</q>',100000000,[0,15]);Game.MakeTiered(Game.last,6,0);
		new Game.Upgrade('Trillion fingers','Multiplies the gain from Thousand fingers by <b>10</b>.<q>clickityclickityclickityclickity</q>',1000000000,[0,16]);Game.MakeTiered(Game.last,7,0);
		...
		order=100;
		new Game.Upgrade('Quadrillion fingers','Multiplies the gain from Thousand fingers by <b>10</b>.<q>clickityclickityclickityclickityclick</q>',10000000000,[0,17]);Game.MakeTiered(Game.last,8,0);
		...
		order=100;
		new Game.Upgrade('Septillion fingers','Multiplies the gain from Thousand fingers by <b>30</b>.<q>[cursory flavor text]</q>',10000000000000000000,[12,20]);Game.MakeTiered(Game.last,11,0);
		new Game.Upgrade('Octillion fingers','Multiplies the gain from Thousand fingers by <b>30</b>.<q>Turns out you <b>can</b> quite put your finger on it.</q>',10000000000000000000000,[12,19]);Game.MakeTiered(Game.last,12,0);
		...
		order=100;new Game.Upgrade('Nonillion fingers','Multiplies the gain from Thousand fingers by <b>40</b>.<q>Only for the freakiest handshakes.</q>',10000000000000000000000000,[12,31]);Game.MakeTiered(Game.last,13,0);
